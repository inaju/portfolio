        ...
        <article className="flex flex-col items-center mt-10 md:flex-row">
            ...
            <div className="ml-2 mt-5 md:mt-0 md:ml-20">
                ...
                <div className="flex mt-4 space-x-4">
                    ...
                    <a
                        className="flex items-center px-5 py-2 duration-100 border-2 rounded-lg fill-current stroke-current text-darkerBlue bg-neon border-neon hover:bg-transparent hover:cursor-pointer hover:text-neon"
